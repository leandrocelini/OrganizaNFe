inherited dlgConfig: TdlgConfig
  ...
  object panelTopo: TPanel [1]
    ...
    object dirLocalGravacao: TJvDirectoryEdit
      Left = 8
      Top = 27
      Width = 657
      Height = 21
  ...
  object qrConfig: TZQuery
    ...
    Params = <>
    Left = 464
    object qrConfigId_Config: TIntegerField
      FieldName = 'Id_Config'
    end
    object qrConfiglocalGravacao: TWideStringField
      DisplayLabel = 'Local de Grava'#231#227'o'
