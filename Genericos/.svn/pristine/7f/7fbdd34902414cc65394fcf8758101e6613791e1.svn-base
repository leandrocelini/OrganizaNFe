...
function Bematech_FI_GeraRegistrosCAT52MFD( Arquivo:String; Data:String ):Integer; StdCall; External 'BEMAFI32.DLL';
...
function Bematech_FI_VersaoDll(cVersao:String):Integer; StdCall; External 'BEMAFI32.DLL' Name 'Bematech_FI_VersaoDll';

//Função utilizada para retornar a descrição do erro
function Bematech_Erros(Numero:Integer):String;
